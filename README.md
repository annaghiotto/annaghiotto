# 💫 About Me:
Currently learning: Data Engineering on AWS
...
|----------|-------------|---------------|
| [**ReplayBG**](https://replaybg.duckdns.org/) | Web-based Digital Twin tool for Type 1 Diabetes leveraging the ReplayBG library. | Python, Django, PostgreSQL, Flutter, REST API |
